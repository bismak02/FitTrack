...
sudo cp -v /home/vagrant/team01o-2024/code/client/nginx/nginx.conf /etc/nginx/
sudo cp -v /home/vagrant/team01o-2024/code/client/nginx/default /etc/nginx/sites-available/
# This connects the TLS certs built in this script with the instances
sudo cp -v /home/vagrant/team01o-2024/code/client/nginx/self-signed.conf /etc/nginx/snippets/
